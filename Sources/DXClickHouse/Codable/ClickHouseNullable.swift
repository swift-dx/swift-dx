...
// encoder/decoder bridges to ClickHouseNullable at the wire boundary.
public enum ClickHouseNullable<Wrapped: Sendable>: Sendable {
...
extension ClickHouseNullable: Equatable where Wrapped: Equatable {}
