...
// Async/await wrapper around the synchronous RawClickHouseConnection.
...
public final actor AsyncRawClickHouseConnection {

    private let worker: DispatchQueue
    private let transport: TransportBox

    public nonisolated var serverInfo: RawClickHouseConnection.ServerInfo {
    ...
    public init(
        ...
        self.worker = worker
        let connection: RawClickHouseConnection = try await withCheckedThrowingContinuation { continuation in
            worker.async {
                do {
