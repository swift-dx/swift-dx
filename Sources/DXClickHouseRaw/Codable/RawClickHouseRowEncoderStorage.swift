...
final class RawClickHouseRowEncoderStorage {
    ...
    func endRow() throws(RawClickHouseError) {
    ...
    func materialize() -> [RawClickHouseNamedColumn] {
        columns.map { RawClickHouseNamedColumn(name: $0.name, column: $0.snapshot()) }
    }

    func appendString(_ value: String, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .string) { $0.appendString(value) }
    }

    func appendNullableString(_ value: RawClickHouseNullable<String>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableString) { $0.appendNullableString(value) }
    }

    func appendBool(_ value: Bool, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .bool) { $0.appendBool(value) }
    }

    func appendNullableBool(_ value: RawClickHouseNullable<Bool>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableBool) { $0.appendNullableBool(value) }
    }

    func appendInt8(_ value: Int8, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .int8) { $0.appendInt8(value) }
    }

    func appendInt16(_ value: Int16, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .int16) { $0.appendInt16(value) }
    }

    func appendInt32(_ value: Int32, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .int32) { $0.appendInt32(value) }
    }

    func appendInt64(_ value: Int64, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .int64) { $0.appendInt64(value) }
    }

    func appendNullableInt8(_ value: RawClickHouseNullable<Int8>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableInt8) { $0.appendNullableInt8(value) }
    }

    func appendNullableInt16(_ value: RawClickHouseNullable<Int16>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableInt16) { $0.appendNullableInt16(value) }
    }

    func appendNullableInt32(_ value: RawClickHouseNullable<Int32>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableInt32) { $0.appendNullableInt32(value) }
    }

    func appendNullableInt64(_ value: RawClickHouseNullable<Int64>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableInt64) { $0.appendNullableInt64(value) }
    }

    func appendUInt8(_ value: UInt8, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .uint8) { $0.appendUInt8(value) }
    }

    func appendUInt16(_ value: UInt16, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .uint16) { $0.appendUInt16(value) }
    }

    func appendUInt32(_ value: UInt32, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .uint32) { $0.appendUInt32(value) }
    }

    func appendUInt64(_ value: UInt64, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .uint64) { $0.appendUInt64(value) }
    }

    func appendNullableUInt8(_ value: RawClickHouseNullable<UInt8>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableUInt8) { $0.appendNullableUInt8(value) }
    }

    func appendNullableUInt16(_ value: RawClickHouseNullable<UInt16>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableUInt16) { $0.appendNullableUInt16(value) }
    }

    func appendNullableUInt32(_ value: RawClickHouseNullable<UInt32>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableUInt32) { $0.appendNullableUInt32(value) }
    }

    func appendNullableUInt64(_ value: RawClickHouseNullable<UInt64>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableUInt64) { $0.appendNullableUInt64(value) }
    }

    func appendFloat(_ value: Float, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .float32) { $0.appendFloat(value) }
    }

    func appendDouble(_ value: Double, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .float64) { $0.appendDouble(value) }
    }

    func appendNullableFloat(_ value: RawClickHouseNullable<Float>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableFloat32) { $0.appendNullableFloat(value) }
    }

    func appendNullableDouble(_ value: RawClickHouseNullable<Double>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableFloat64) { $0.appendNullableDouble(value) }
    }

    func appendDateTime(_ value: Date, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .dateTime) { $0.appendDateTime(value) }
    }

    func appendNullableDateTime(_ value: RawClickHouseNullable<Date>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableDateTime) { $0.appendNullableDateTime(value) }
    }

    func appendUUID(_ value: UUID, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .uuid) { $0.appendUUID(value) }
    }

    func appendNullableUUID(_ value: RawClickHouseNullable<UUID>, forColumn name: String) throws(RawClickHouseError) {
        try append(name: name, kind: .nullableUUID) { $0.appendNullableUUID(value) }
    }

    private func append(name: String, kind: SlotKind, _ body: (Slot) -> Void) throws(RawClickHouseError) {
        let slotIndex = try resolveSlot(name: name, kind: kind)
        body(columns[slotIndex])
        touched[slotIndex] = true
    }

    private func resolveSlot(name: String, kind: SlotKind) throws(RawClickHouseError) -> Int {
    ...
    private func requireSameKind(existing: Int, incoming: SlotKind, name: String) throws(RawClickHouseError) {
...
// `RawClickHouseTypedColumn` case at the end of `materialize()`. The
...
final class Slot {
    ...
    private var nullableStringValues: [RawClickHouseNullable<String>] = []
    private var boolValues: [Bool] = []
    private var nullableBoolValues: [RawClickHouseNullable<Bool>] = []
    private var int8Values: [Int8] = []
    private var int16Values: [Int16] = []
    private var int32Values: [Int32] = []
    private var int64Values: [Int64] = []
    private var nullableInt8Values: [RawClickHouseNullable<Int8>] = []
    private var nullableInt16Values: [RawClickHouseNullable<Int16>] = []
    private var nullableInt32Values: [RawClickHouseNullable<Int32>] = []
    private var nullableInt64Values: [RawClickHouseNullable<Int64>] = []
    ...
    private var nullableUInt8Values: [RawClickHouseNullable<UInt8>] = []
    private var nullableUInt16Values: [RawClickHouseNullable<UInt16>] = []
    private var nullableUInt32Values: [RawClickHouseNullable<UInt32>] = []
    private var nullableUInt64Values: [RawClickHouseNullable<UInt64>] = []
    private var float32Values: [Float] = []
    private var float64Values: [Double] = []
    private var nullableFloat32Values: [RawClickHouseNullable<Float>] = []
    private var nullableFloat64Values: [RawClickHouseNullable<Double>] = []
    private var dateTimeValues: [Date] = []
    private var nullableDateTimeValues: [RawClickHouseNullable<Date>] = []
    private var uuidValues: [UUID] = []
    private var nullableUUIDValues: [RawClickHouseNullable<UUID>] = []
    ...
    func appendNullableString(_ value: RawClickHouseNullable<String>) { nullableStringValues.append(value) }
    func appendBool(_ value: Bool) { boolValues.append(value) }
    func appendNullableBool(_ value: RawClickHouseNullable<Bool>) { nullableBoolValues.append(value) }
    ...
    func appendNullableInt8(_ value: RawClickHouseNullable<Int8>) { nullableInt8Values.append(value) }
    func appendNullableInt16(_ value: RawClickHouseNullable<Int16>) { nullableInt16Values.append(value) }
    func appendNullableInt32(_ value: RawClickHouseNullable<Int32>) { nullableInt32Values.append(value) }
    func appendNullableInt64(_ value: RawClickHouseNullable<Int64>) { nullableInt64Values.append(value) }
    ...
    func appendNullableUInt8(_ value: RawClickHouseNullable<UInt8>) { nullableUInt8Values.append(value) }
    func appendNullableUInt16(_ value: RawClickHouseNullable<UInt16>) { nullableUInt16Values.append(value) }
    func appendNullableUInt32(_ value: RawClickHouseNullable<UInt32>) { nullableUInt32Values.append(value) }
    func appendNullableUInt64(_ value: RawClickHouseNullable<UInt64>) { nullableUInt64Values.append(value) }
    func appendFloat(_ value: Float) { float32Values.append(value) }
    func appendDouble(_ value: Double) { float64Values.append(value) }
    func appendNullableFloat(_ value: RawClickHouseNullable<Float>) { nullableFloat32Values.append(value) }
    func appendNullableDouble(_ value: RawClickHouseNullable<Double>) { nullableFloat64Values.append(value) }
    func appendDateTime(_ value: Date) { dateTimeValues.append(value) }
    func appendNullableDateTime(_ value: RawClickHouseNullable<Date>) { nullableDateTimeValues.append(value) }
    func appendUUID(_ value: UUID) { uuidValues.append(value) }
    func appendNullableUUID(_ value: RawClickHouseNullable<UUID>) { nullableUUIDValues.append(value) }

    func snapshot() -> RawClickHouseTypedColumn {
        switch kind {
