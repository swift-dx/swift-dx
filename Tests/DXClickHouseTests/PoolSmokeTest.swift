...
@Suite(
    "ClickHouseConnectionPool smoke",
    .enabled(if: ProcessInfo.processInfo.environment["CH_INTEGRATION_HOST"] != nil)
)
struct ClickHouseConnectionPoolSmoke {
    ...
    private static func makePool(minConnections: Int = 1, maxConnections: Int = 4) async throws -> ClickHouseConnectionPool {
